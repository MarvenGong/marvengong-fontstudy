...
https://github.com/leungwensen/mindmap-layouts/blob/master/lib/algorithms/non-layered-tidy-tree.js
 */
...
WrappedTree.fromNode = (root, isHorizontal) => {
  ...
  if (isHorizontal)
    return new WrappedTree(root.size[1], root.size[0], root.x, children);
  return new WrappedTree(root.size[0], root.size[1], root.y, children);
};
