    ...
    execute: function () {
      ...
      _export("btnStart", btnStart = (_dec = ccclass('btnStart'), _dec2 = property({
        ...
        onLoad() {
          ...
          input.on((_Input$EventType = Input.EventType) == null ? void 0 : _Input$EventType.MOUSE_DOWN, this.handleStart, this);
        }
...
//# sourceMappingURL=66b9847c3e7d100d20700a469cab68aa534afae6.js.map